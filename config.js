...
global.sudo = process.env.SUDO || '94784441238'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'VAJIRA 𝐁𝐨𝐭' : process.env.BOT_NAME,*🤗🪄🌈Sudu Baba || 💗🖇️
  ownername: process.env.OWNER_NAME === undefined ? 'Vajira' : process.env.OWNER_NAME,Cyber Lakiya|🐣💕🔗
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,VAJIRA;;;ScrewsOptions
